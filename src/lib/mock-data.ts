...
export const alerts: Alert[] = [
  {
    ...
    type: "pest",
    severity: "high",
    title: "Varroa Mite Risk Predicted",
    description: "Sensor analysis detected abnormal vibration patterns and a 0.4 kg unexplained weight drop over 3 days, combined with elevated hive temperature (+2.3°C above brood norm). These patterns correlate with Varroa mite infestation. Risk probability: 78%.",
    recommendation: "Perform a manual inspection within 48 hours to confirm Varroa presence. If confirmed, apply approved miticide treatment. Consider oxalic acid vaporization during brood-free period. Schedule follow-up inspection in 7 days.",
  ...
  },
  {
    ...
    type: "disease",
    severity: "critical",
    title: "Possible Foulbrood Risk Predicted",
    description: "Sensor data shows sustained internal temperature elevation (+3.1°C), abnormal humidity spikes (72% avg vs 55% norm), and a 1.2 kg weight decline over 5 days — patterns consistent with American Foulbrood onset. Risk probability: 82%. Manual inspection required urgently.",
